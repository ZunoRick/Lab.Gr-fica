...
GLfloat MercuryDiffuse[] = { 1.0f, 0.0f, 0.0f, 1.0f };			// Mercurio
GLfloat MercurySpecular[] = { 0.909f, 0.333f, 0.047f, 1.0 };
GLfloat MercuryShininess[] = { 30.0 };

GLfloat VenusDiffuse[] = { 1.0f, 1.0f, 0.0f, 1.0f };			//Venus
GLfloat VenusSpecular[] = { 1.0f, 0.788f, 0.101f, 1.0 };
GLfloat VenusShininess[] = { 40.0 };

GLfloat EarthDiffuse[]= { 0.2f, 0.2f, 1.0f, 1.0f };			// Tierra
GLfloat EarthSpecular[] = { 0.0, 1.0f, 0.741f, 1.0 };
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(camaraX-0,0.0,-50.0+camaraZ);	
	...
	glPushMatrix();
		...
		glMaterialfv(GL_FRONT, GL_SPECULAR, MercuryDiffuse);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, MercurySpecular);
	...
	glPushMatrix();
		...
		glMaterialfv(GL_FRONT, GL_DIFFUSE, VenusSpecular);
	...
	glPushMatrix();
		...
		glMaterialfv(GL_FRONT, GL_DIFFUSE, EarthSpecular);
		...
		glPushMatrix();
			...
			glMaterialfv(GL_FRONT, GL_DIFFUSE, MoonSpecular);
